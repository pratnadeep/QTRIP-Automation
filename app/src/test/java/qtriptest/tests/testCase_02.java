...
public class testCase_02{
   ...
   public static void createDriver() throws MalformedURLException {
    ...
    @Test(dataProvider = "DatasetsforQTrip", dataProviderClass =DP.class, enabled = true, description = "verify Search and Filter flow" , priority = 2, groups={"Search and Filter flow"})
     public  void TestCase02( String CityName, String CategoryFilter, String DurationFilter,String FilterdResult,String UnfilteredResult) throws InterruptedException{
      ...
      home.navigateToHomePage();
       ...
       adventure.setCatrgoryFilter(CategoryFilter);
